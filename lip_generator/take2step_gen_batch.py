...
def load_robot():
    ...
    robot = pinocchio.RobotWrapper.BuildFromURDF(
        "/home/zimengchai/Documents/lip_generator/model/T1_7dof_arms_with_gripper.urdf",
        package_dirs=["/home/zimengchai/Documents/lip_generator/model"],
...
def generate_grid_samples(lfPos0, rfPos0, left_stance_range, right_stance_range, grid_x_steps, grid_y_steps, grid_yaw_steps):
    """
    Generate a grid of two-step foot target positions with separate ranges for each stance.
    ...
    Returns:
        List of dicts with step1 and step2 displacement information for two-step sequences
    """
    samples = []

    # Generate samples starting with left foot stance (right foot swings first, then left)
